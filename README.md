...
* Scan game and editor scripts
* Reference folders (useful for finding unused third party scripts)
...
## How does it work?
The method is very brute force. IT just scans all the files wihtin a project that have visible meta files and builds an internal map with with it cross references to determine if they have a use (using AssetDatabase.GetDependencies)
